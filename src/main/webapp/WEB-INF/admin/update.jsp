...
<body>
<div class="container">
    <form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/update_edition" method="post">
        <h3>New edition</h3>
        ...
        <button type="submit" class="btn btn-default">Update Edition</button>
    </form>
</div>
</body>
</html>
